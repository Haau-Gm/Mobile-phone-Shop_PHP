...
if(isset($_POST['themdanhmuc'])){
    if($tenloaisp=='' || $thutu==''){
        ...
        $ketqua = ThemDanhMuc($tenloaisp, $thutu);
        // Kiểm tra giá trị trả về từ hàm ThemDanhMuc
        if ($ketqua === true) {
            header('Location:../index.php?action=quanlydanhmucsanpham&query=them');
        } else {
            header('Location:../index.php?action=quanlydanhmucsanpham&query=them&thongbao=trungthongtin');
        }
    }
    // else{
    ...
    if($tenloaisp=='' || $thutu==''){
        ...
        $ketqua = SuaDanhMuc($_GET['iddanhmuc'],$tenloaisp,$thutu);
        // Kiểm tra giá trị trả về từ hàm ThemDanhMuc
        if ($ketqua === true) {
            header('Location:../index.php?action=quanlydanhmucsanpham&query=them');
        } else {
